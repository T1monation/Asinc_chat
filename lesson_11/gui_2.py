...
from add_frend_dialog import AddToFrend
...
class My_Window(QMainWindow):
    ...
    def get_new_message(self, message):
        ...
        if message["action"] == "msg":
            if message["name"] == self.current_chat:
                ...
                try:
                    ...
                    if message["name"] == "server":
                        ...
                        if self.message_box.question(self, f"Пользователь {message['name']} прислал сообщение", "Добавить в друзья?", QMessageBox.StandardButton.Yes, QMessageBox.StandardButton.No) == QMessageBox.StandardButton.Yes:
